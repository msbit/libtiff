...
static const TIFFField tiffFields[] = {
    ...
    {TIFFTAG_GEO_PIXELSCALE, -1, -1, TIFF_DOUBLE, 0, TIFF_SETGET_C16_DOUBLE, FIELD_CUSTOM, 1, 1, "ModelPixelScaleTag"},
    {TIFFTAG_GEO_TIEPOINT, -1, -1, TIFF_DOUBLE, 0, TIFF_SETGET_C16_DOUBLE, FIELD_CUSTOM, 1, 1, "ModelTiepointTag"},
    {TIFFTAG_GEO_GEOKEYDIRECTORY, -1, -1, TIFF_SHORT, 0, TIFF_SETGET_C16_UINT16, FIELD_CUSTOM, 1, 1, "GeoKeyDirectoryTag"},
